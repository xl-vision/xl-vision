...
const Code: React.FunctionComponent<CodeProps> = props => {
    ...
    return (
        <Wrapper>
            <Bar>
                <Button isActive={codeType === CodeType.TYPESCRIPT} onClick={() => setCodeType(CodeType.TYPESCRIPT)}>Typescript</Button>
                <Button isActive={codeType === CodeType.JAVASCRIPT} onClick={() => setCodeType(CodeType.JAVASCRIPT)}>Javascript</Button>
            </Bar>
